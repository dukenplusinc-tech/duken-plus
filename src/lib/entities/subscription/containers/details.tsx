...

        {
          <div className="text-center">
            <Link href={whatsappLink} target="_blank">
              <Badge
                className={cn(
                  'text-white text-lg py-2 px-4 rounded-md',
            ...
            <div className="bg-green-500 text-white p-4 rounded-lg">
              ...
              <div className="text-center">
                <Link
                  ...
                  className="inline-flex items-center justify-center gap-2 bg-white text-green-600 px-4 py-2 rounded-md font-medium hover:bg-gray-100"
                >
                  <svg
