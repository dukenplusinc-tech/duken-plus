...
drop index if exists "public"."cash_shifts_shop_date_idx";

CREATE UNIQUE INDEX cash_shifts_shop_number_idx ON public.cash_shifts USING btree (shop_id, shift_number);
